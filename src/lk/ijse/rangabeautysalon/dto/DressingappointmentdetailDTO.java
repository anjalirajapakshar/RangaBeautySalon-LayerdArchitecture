...
public class DressingappointmentdetailDTO {
    private String appId;
    private String dressing_id;
    private String date;

    public DressingappointmentdetailDTO() {
    }

    public DressingappointmentdetailDTO(String appId, String dressing_id, String date) {
        this.appId = appId;
