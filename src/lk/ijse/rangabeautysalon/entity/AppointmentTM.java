...
public class AppointmentTM implements SuperEntity {
    ...
    public AppointmentTM(String appId, String CID, String description, String salonService, String dressingId, String date, String time) {
        AppId = appId;
        this.CID = CID;
